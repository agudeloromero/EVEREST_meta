...
#		expand(os.path.join(config["output_DIR"], "EVEREST/SPADES/{sample}/scaffolds.fasta"), sample=SAMPLES),
		...
		#Stats contigs
		expand(os.path.join(config["output_DIR"], "EVEREST/BBMAP_stats/{sample}_rpkm.txt"), sample=SAMPLES),
		expand(os.path.join(config["output_DIR"], "EVEREST/BBMAP_stats/{sample}_stats.txt"), sample=SAMPLES),
		expand(os.path.join(config["output_DIR"], "EVEREST/BBMAP_stats/{sample}_normcov.txt"), sample=SAMPLES),
		#Classification
